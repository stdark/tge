function npc_load ()
	...
	npc.ttx={
		...
		--dortussmarttooth = {
		--uid=3,person="npc",control="ai",defaultai="stay",ai="stay",dangerai="agr",x=20,y=10,rot=2,class="ratman",fraction="contrabandists", party=3, name=npc.names.rattusparchedtail, face = 8,
		--},
