...
feelssleepy={ " хочет спать", " хочет спать"," хочет спать"},
insane={ " обезумел", " обезумела"," обезумело"},
...
party_got_a_secret="Команда получила полезную информацию!",
calledguards={" позвал охрану"," позвала охрану", " позвало охрану"},
basiliskbreath_prevents_satiation={"сглаз не даёт насытиться"},
gotpromotion={" получил продвижение!"," получила провижение!"," получило продвижение!"},
fractions_relations_changed="Отношения между фракциями изменились...",
};
...
lognames.mob_names={goblin=" гоблин ",ogre=" огр ", rogue=" вор ", mage=" маг ",golem=" голем ", naga=" нага ", ratman="крысолюд", fireelemental=" элементал огня ", airelemental=" элементал воздуха ", waterelemental=" элементал воды ", earthelemental=" элементал земли "};
...
hp="единицы жизни ", sp="единицы маны ", st="единицы бодрости ", rt="единицы готовности",vigor="бодрость",
atkm="атака ", atkr="стрельба ", dmgm="урон в ближнем бою", dmgr="урон в стрелковом бою", dmg="урон",
ac="класс брони", dt="порог брони",dr="поглощение",dodge="шанс на уклонение", parry="шанс на парирование", block="шанс на блок",
...
lv="уровень",xp="опыт", class="класс", moral = "мораль", satiation="сытость", sleepiness = "сонливость", burden="нагрузка",name="имя"
};

lognames.skills={
unarmed="без оружия",sword="меч",axe="топор",flagpole="древковое",crushing="дробящее",staff="посох",dagger="кинжал",bow="лук",crossbow="арбалет",throwing="метательное",firearms="огнестрел",blaster="бластер",
...
cantbeequiped="не требует умений",none="не требует умений", reading="чтение", music="музыка",astrology="астрология",
};
...
leather="кожаный доспех", chainmail="кольчужный доспех", plate="латный доспех", shield="щит", music="музыкальными инструментами",
...
assasin="убийца",spy="шпион",thief="вор",rogue="разбойник",burglar="налётчик",brigant="бандит",seccol="сексот",agent="агент",bard="бард",
...
fractions={party="партия",greens="зеленухи",bandidos="бандиты",bloggers="неписи",vagrants="бродяги",merchants="торговцы",contrabandists="контрабандисты"};
mind_fractions={party="Я в лучшей команде на свете!",greens="Зеленухи, вперёд!",bandidos="Обчищу, на нож посажу!",bloggers="Хочу поговорить!",vagrants="Эх, путь-дорога!",merchants="Прибытку бы...",contrabandist="Хочешь жить — умей вертеться!"};
...
dex="Ловкость влияет на координацию движений,\nпозволяет затрачивать меньше сил\nна атаки ближнего боя и перемещения.\nЭто весьма полезная характеристика\nдля взломщиков, специалистов по скрытым атакам\n и перемещениям.",
...
blaster="Навык использования оружия Древних.",
...
music="Навык игры на музыкальных инструментах",
astrology="Навык предсказания будущего",
};
