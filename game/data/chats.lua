...
function chats.load ()
	...
	{chats.questionPerEtiquette("whoru",chars_mobs_npcs[current_mob]["personality"]["current"].etiquette),"Что ты здесь делаешь?","Покажи дорогу к ближайшему городу!","Попробую тебя убедить..."},
...
function chats.questionPerEtiquette(question,etiquette)
	local questions = {
	whoru={none="Кто ты?",peasant="Ты кто?",criminal="Ты шо за фраер?",noble="С кем имею честь беседовать?",warrior="Имя, звание, кто командующий?",lightpriest="Назови имя своё, чадо!",darkpriest="Что написать на твоём надгробии, жертва?",savage="Твоя есть кто?",scientist="Могу я узнать ваше имя?"},
