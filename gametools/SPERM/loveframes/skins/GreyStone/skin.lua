...
skin.name = "GreyStone"
skin.author = "Alexander Tkachenko"
skin.version = "0.1"
--skin.base = "Blue"

local default_font = loveframes.config["DIRECTORY"] .. "/skins/" .. skin.name .. "/HoMMFontCyr.ttf"
local smallfont = love.graphics.newFont(10)
local imagebuttonfont = love.graphics.newFont(default_font, 15)
